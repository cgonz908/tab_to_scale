...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/Applications/anaconda3/envs/t2s/bin',
 'BINLIBDEST': '/Applications/anaconda3/envs/t2s/lib/python3.7',
 'BLDLIBRARY': '-L. -lpython3.7m',
 'BLDSHARED': 'gcc -bundle -undefined dynamic_lookup '
              '-L/Applications/anaconda3/envs/t2s/lib  '
              '-arch x86_64 '
              '-L/Applications/anaconda3/envs/t2s/lib  '
              '-arch x86_64',
 'BUILDEXE': '.exe',
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG -g '
           ...
           '-I/Applications/anaconda3/envs/t2s/include  '
           '-arch x86_64 '
           '-I/Applications/anaconda3/envs/t2s/include  '
           '-arch x86_64',
 'CFLAGSFORSHARED': '',
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-I/Applications/anaconda3/envs/t2s/include  '
                     '-arch x86_64',
 'CONFIGURE_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-result '
                            '-Wno-unused-parameter '
                            '-Wno-missing-field-initializers',
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-L/Applications/anaconda3/envs/t2s/lib  '
                      '-arch x86_64',
 'CONFIG_ARGS': "'--enable-shared' '--enable-ipv6' '--with-ensurepip=no' "
                "'--prefix=/Applications/anaconda3/envs/t2s' "
                "'CFLAGS=-I/Applications/anaconda3/envs/t2s/include  "
                "-arch x86_64' "
                "'LDFLAGS=-L/Applications/anaconda3/envs/t2s/lib  "
                "-arch x86_64' "
                "'PKG_CONFIG_PATH=/Applications/anaconda3/envs/t2s/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/Applications/anaconda3/envs/t2s/include',
 'CONFINCLUDEPY': '/Applications/anaconda3/envs/t2s/include/python3.7m',
 'COREPYTHONPATH': ':',
 'COVERAGE_INFO': '/Applications/anaconda3/envs/t2s/../work/Python-3.7.3/coverage.info',
 'COVERAGE_REPORT': '/Applications/anaconda3/envs/t2s/../work/Python-3.7.3/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include',
 'CXX': 'g++',
 'DESTDIRS': '/Applications/anaconda3/envs/t2s '
             '/Applications/anaconda3/envs/t2s/lib '
             '/Applications/anaconda3/envs/t2s/lib/python3.7 '
             '/Applications/anaconda3/envs/t2s/lib/python3.7/lib-dynload',
 'DESTLIB': '/Applications/anaconda3/envs/t2s/lib/python3.7',
 'DESTPATH': '',
 'DESTSHARED': '/Applications/anaconda3/envs/t2s/lib/python3.7/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/Applications/anaconda3/envs/t2s/include '
                   '/Applications/anaconda3/envs/t2s/include '
                   '/Applications/anaconda3/envs/t2s/include/python3.7m '
                   '/Applications/anaconda3/envs/t2s/include/python3.7m',
 'INCLUDEDIR': '/Applications/anaconda3/envs/t2s/include',
 'INCLUDEPY': '/Applications/anaconda3/envs/t2s/include/python3.7m',
 ...
 'LDVERSION': '3.7m',
 'LIBC': '',
 'LIBDEST': '/Applications/anaconda3/envs/t2s/lib/python3.7',
 'LIBDIR': '/Applications/anaconda3/envs/t2s/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/Applications/anaconda3/envs/t2s/lib/pkgconfig',
 'LIBPL': '/Applications/anaconda3/envs/t2s/lib/python3.7/config-3.7m-darwin',
 ...
 'MACHDEPPATH': ':',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/Applications/anaconda3/envs/t2s/lib/python3.7',
 'MACOSX_DEPLOYMENT_TARGET': '10.9',
 'MAINCC': 'gcc',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/Applications/anaconda3/envs/t2s/share/man',
 ...
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/Applications/anaconda3/envs/t2s/lib  '
               '-arch x86_64 '
               '-L/Applications/anaconda3/envs/t2s/lib  '
               '-arch x86_64',
 'Py_DEBUG': 0,
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'DYLD_LIBRARY_PATH=/Applications/anaconda3/envs/t2s/../work/Python-3.7.3',
 'SCRIPTDIR': '/Applications/anaconda3/envs/t2s/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'DYLD_LIBRARY_PATH=/Applications/anaconda3/envs/t2s/../work/Python-3.7.3 '
               './python.exe',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'DYLD_LIBRARY_PATH=/Applications/anaconda3/envs/t2s/../work/Python-3.7.3 '
 ...
 'abs_builddir': '/Applications/anaconda3/envs/t2s/../work/Python-3.7.3',
 'abs_srcdir': '/Applications/anaconda3/envs/t2s/../work/Python-3.7.3',
 'datarootdir': '/Applications/anaconda3/envs/t2s/share',
 'exec_prefix': '/Applications/anaconda3/envs/t2s',
 'prefix': '/Applications/anaconda3/envs/t2s',
 'srcdir': '.'}
