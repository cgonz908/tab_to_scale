...
# dir.
tdbc_LIB_SPEC="-L/Applications/anaconda3/envs/t2s/lib/tdbc1.1.1 -ltdbc1.1.1"
TDBC_LIB_SPEC="-L/Applications/anaconda3/envs/t2s/lib/tdbc1.1.1 -ltdbc1.1.1"
...
# String to pass to the linker to pick up the TDBC stub library from its
# installed directory
tdbc_STUB_LIB_SPEC="-L/Applications/anaconda3/envs/t2s/lib/tdbc1.1.1 -ltdbcstub1.1.1"
TDBC_STUB_LIB_SPEC="-L/Applications/anaconda3/envs/t2s/lib/tdbc1.1.1 -ltdbcstub1.1.1"
...
tdbc_STUB_LIB_PATH="/Applications/anaconda3/envs/t2s/lib/tdbc1.1.1/libtdbcstub1.1.1.a"
TDBC_STUB_LIB_PATH="/Applications/anaconda3/envs/t2s/lib/tdbc1.1.1/libtdbcstub1.1.1.a"
...
# headers
tdbc_INCLUDE_SPEC="-I/Applications/anaconda3/envs/t2s/include"
TDBC_INCLUDE_SPEC="-I/Applications/anaconda3/envs/t2s/include"
...
tdbc_LIBRARY_PATH="/Applications/anaconda3/envs/t2s/lib/tdbc1.1.1"
TDBC_LIBRARY_PATH="/Applications/anaconda3/envs/t2s/lib/tdbc1.1.1"
