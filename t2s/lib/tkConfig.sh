...
# installed.
TK_PREFIX='/Applications/anaconda3/envs/t2s'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Applications/anaconda3/envs/t2s'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Applications/anaconda3/envs/t2s/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Applications/anaconda3/envs/t2s/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Applications/anaconda3/envs/t2s/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/Applications/anaconda3/envs/t2s/lib/libtkstub8.6.a'
